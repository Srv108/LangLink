...
SECRET_KEY = 'django-insecure-2bpoe%f*nsar_64th0#8$$-ig*g5ir#hd2k_*pq+ni%84b213l'
...
# We are using the in-memory channel layer for development.
# This removes the need for a Redis server.
CHANNEL_LAYERS = {
    'default': {
